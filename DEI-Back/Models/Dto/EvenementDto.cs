...
namespace DEI.Models.Dto
{
    public class EvenementDto
    {
        ...
        public string? DescriptionFaits { get; set; }
            public string? SchemaUrl { get; set; }  // <-- ajouter cette ligne
        ...
        public string? FamilleEvenementIndesirableLibelle { get; set; }

        public List<DEI.Models.Dto.ActionCorrectiveDto> ActionsCorrectives { get; set; } = new List<DEI.Models.Dto.ActionCorrectiveDto>();
    }
}