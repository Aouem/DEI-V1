...
namespace DEI.Migrations
{
    ...
    [Migration("20250818114712_AddEvenementFields")]
    partial class AddEvenementFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEMxg/WgNt9ClhqP/lWvtuMNHRKsxY1ysWr253zWpMGdh5lX0NYfu3EZgsFfG3HqIQw==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
