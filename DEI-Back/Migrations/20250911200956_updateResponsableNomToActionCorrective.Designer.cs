...
namespace DEI.Migrations
{
    ...
    [Migration("20250911200956_updateResponsableNomToActionCorrective")]
    partial class updateResponsableNomToActionCorrective
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEP3EHUgE4yx3THA1xFEWXaeWe6W9WGoyupaKUrksPQq3MuN/fRSrnGOD2w8Mioc0ew==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
