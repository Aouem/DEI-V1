...
namespace DEI.Migrations
{
    ...
    [Migration("20250816063825_AddEvitableToEvenementIndesiralecontroller")]
    partial class AddEvitableToEvenementIndesiralecontroller
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEJSbxeBy19Fdo8x6uzW2ugjrhF47iTHMbXnCgoMRXefoy5FKg3TxI19SuqnxTNgwUg==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
