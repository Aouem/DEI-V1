...
namespace DEI.Migrations
{
    ...
    [Migration("20250911194738_majResponsableNomToActionCorrective")]
    partial class majResponsableNomToActionCorrective
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEI17Kn4AF46PI5S0xl99+VAvIDCClpr6L17ZMCE4XOl1NvqBhiX1Ad/WiRYQYk8Uag==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
