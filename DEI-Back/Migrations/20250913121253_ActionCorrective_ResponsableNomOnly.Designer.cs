...
namespace DEI.Migrations
{
    ...
    [Migration("20250913121253_ActionCorrective_ResponsableNomOnly")]
    partial class ActionCorrective_ResponsableNomOnly
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEE7xLVR6Nh92KwEwmRESNX0fG1EEiDJAGWHGLFDSDs8VW9T/zeb5wEVAJjnbRB9zwg==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
            ...
            modelBuilder.Entity("DEI.Models.ActionCorrective", b =>
                {
                    ...
                    b.HasOne("DEI.Models.Utilisateur", null)
