...
namespace DEI.Migrations
{
    ...
    [Migration("20250816061100_AddEvitableToEvenementIndesirableenum")]
    partial class AddEvitableToEvenementIndesirableenum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEF5Zpm5mcx0G06sJtIqa5zUBXRqvsrxkNX6qkBegiCwLbF/t0dx2IRrT1fylvubz4g==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
