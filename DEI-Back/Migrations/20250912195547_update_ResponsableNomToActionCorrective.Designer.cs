...
namespace DEI.Migrations
{
    ...
    [Migration("20250912195547_update_ResponsableNomToActionCorrective")]
    partial class update_ResponsableNomToActionCorrective
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEIb4JpKtEKRvTBrq0OTWFEI8T83F/wtYi7IoJ9y+eM6E7KgRvhag7Z+c1gGnvSTzfQ==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
