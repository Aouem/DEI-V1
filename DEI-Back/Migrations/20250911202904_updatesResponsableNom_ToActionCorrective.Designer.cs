...
namespace DEI.Migrations
{
    ...
    [Migration("20250911202904_updatesResponsableNom_ToActionCorrective")]
    partial class updatesResponsableNom_ToActionCorrective
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEDr1aLF5HFQC5Ogm8BHqyIn16C3CqXKfuJn+SHEN9cXVreGeBFMXspW+2CRaq4o/1A==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
