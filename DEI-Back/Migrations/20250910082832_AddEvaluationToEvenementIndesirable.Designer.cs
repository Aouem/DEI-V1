...
namespace DEI.Migrations
{
    ...
    [Migration("20250910082832_AddEvaluationToEvenementIndesirable")]
    partial class AddEvaluationToEvenementIndesirable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEIi5tM8ZqMYcv3lSlwAW3LQIq60rp0fn0Nxx7OaMcy1FGRuhW66OdCla24ZRETAYyQ==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
