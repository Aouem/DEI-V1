...
namespace DEI.Migrations
{
    ...
    [Migration("20250916093943_AddSchemaUrl")]
    partial class AddSchemaUrl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEJt0/uzMi6F7ZoBFiyNHm/KMJvsSGUMZLa4+58r0rvYtHeW8H/isaDo//R0WqBx//w==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
