...
namespace DEI.Migrations
{
    ...
    [Migration("20250906130429_Coordonnateur")]
    partial class Coordonnateur
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEFecM54jWcWl9pbmUZSdFJHWDBXxANUM3XTV6a9bINlDDYHEW1u5zPvm4lu5N2T8dA==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
