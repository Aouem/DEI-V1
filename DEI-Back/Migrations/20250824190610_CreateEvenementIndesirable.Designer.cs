...
namespace DEI.Migrations
{
    ...
    [Migration("20250824190610_CreateEvenementIndesirable")]
    partial class CreateEvenementIndesirable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.EvenementIndesirable", b =>
                {
                    ...
                    b.Property<bool?>("AutreChamp")
                        .HasColumnType("bit");

                    b.Property<string>("AutreChampPrecision")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("EvenementIndesirable");
                });
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEHX0eB4L3z5EREMhpWjzZiiKrIuUIa3jmbN0Oh+tau+G5vzQT5XhD1xqWlr5ucP1qg==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
