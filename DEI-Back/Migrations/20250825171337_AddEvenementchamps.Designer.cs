...
namespace DEI.Migrations
{
    ...
    [Migration("20250825171337_AddEvenementchamps")]
    partial class AddEvenementchamps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEEx+TyFqaFRJFdy4pVDO7fJxmVtfF/0q4L+lPoOZzNeWN97ul5/R3dQU1OU49acBAw==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
