...
namespace DEI.Migrations
{
    ...
    [Migration("20250916092605_AddImageUrlToEvenement")]
    partial class AddImageUrlToEvenement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEAT4WayAu2HKKSa/d7Ql5710SKIMETWat6mmo2qclhuNJQqRpZ3PQmN0b9QiAHt3lw==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
