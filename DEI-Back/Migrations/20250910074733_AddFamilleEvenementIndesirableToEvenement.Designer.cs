...
namespace DEI.Migrations
{
    ...
    [Migration("20250910074733_AddFamilleEvenementIndesirableToEvenement")]
    partial class AddFamilleEvenementIndesirableToEvenement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEANsvV6rAsj1GyxTFW8LHN3gQoOGaZR12IIpXonm6g4slR+TUmN7yH/P5pRvrQKSNA==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
