...
namespace DEI.Migrations
{
    ...
    [Migration("20250906133451_Coordonnateurmodif")]
    partial class Coordonnateurmodif
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAELFYlmX2cpB8b3NH+NmlcVs6uKd2SHaOWXNJIFWIIgTtDo0Q+CfD6aeCIrUutbrS8A==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
