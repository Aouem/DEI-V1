...
namespace DEI.Migrations
{
    ...
    [Migration("20250905083806_AddFournisseurToEvenement")]
    partial class AddFournisseurToEvenement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEI.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEBH+UewwCw1T2YAER1Bk/PfUYtUzMOb054H0AYaV+s4gUJD33/tRp5yaqtDxPEeH6A==",
                            Role = "ADMIN",
                            ServiceId = 1,
                            Tel = "12345678",
                            UserName = "admin"
